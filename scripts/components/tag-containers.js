...
export default class tagContainers {
  static init = () => {
    this.displayTagContainer();
  };

  static displayTagContainer = () => {
      ...
      tag.addEventListener('click', (e) => {
        ...
        tags.forEach((otherTag) => {
          if (otherTag.parentNode.classList.contains('w-1/2')) {
            ...
            input.value = '';
            otherTagDropdown.classList.remove('flex');
            otherTagDropdown.classList.add('hidden');
            otherTagDropdown.classList.remove('h-auto');
        ...
        tagDropdown.classList.add('flex');
        tagDropdown.classList.remove('hidden');
        tagDropdown.classList.add('h-auto');
